...
_sage_const_3 = Integer(3); _sage_const_0p0001 = RealNumber('0.0001'); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2)
import sage.all
import copy
import numpy as np
...
if __name__ == "__main__":
    R = PolynomialRing(QQ, names=('x', 'y', 'z',)); (x, y, z,) = R._first_ngens(_sage_const_3 )
    inputBasis = [x**_sage_const_2   - y, y**_sage_const_2   - x*z - y*z]
